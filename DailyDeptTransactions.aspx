                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <ul class="list-inline">
                                <li><asp:LinkButton ID="BtnRun" CssClass="btn btn-success" runat="server" Text="Go"></asp:LinkButton></li>
                     ...
                     <div class="table-responsive">
                         <asp:DataGrid ID="BatchChecksGrid" runat="server" AutoGenerateColumns="false"  FooterStyle-Font-Bold="true"
                             ...
                             <Columns>
                                 ...
                                 <asp:BoundColumn DataField = "DetectTime"      HeaderStyle-BackColor="#c0c0c0" HeaderText="Detect Time" />
                             </Columns>
                         </asp:DataGrid>
                            </div>
                        </div>
