<%@ Page Title="Outward Transactions" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OutwardDeptList.aspx.cs" Inherits="RTGS.OutwardDeptList" %>
        ...
        <div class="col-md-12">
            <section class="panel">
					...
					<asp:BoundField DataField = "MsgID"        HeaderText="Msg ID"  HeaderStyle-HorizontalAlign="Center"/> 
                                        <asp:BoundField DataField = "InstrId"  HeaderText="Intr. ID" /> 
				    	<asp:BoundField DataField = "TxId"  HeaderText="Tx ID" />  
